  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        "/InputNumber" : (context) => new Directionality(textDirection: TextDirection.rtl, child:  input_number()),
        "/VerifyNumber" : (context) => new Directionality(textDirection: TextDirection.rtl, child:  verify_number('0',0,'0')),
        ...
        "/TravelRequest" : (context) => new Directionality(textDirection: TextDirection.rtl, child:  TravelRequest()),
